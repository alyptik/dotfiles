...
export PATH="${HOME}/bin:${HOME}/.zsh.d/plugins/zplug/bin:${HOME}/.zplug/bin:${HOME}/bin/asski:${HOME}/.local/bin:/usr/local/texlive/2016/bin/x86_64-linux:${HOME}/.node_modules/bin:${HOME}/.gem/ruby/2.4.0/bin:${HOME}/perl5/bin:${HOME}/.cargo/bin:/opt/intel/bin:/store/config/scripts:/opt/android-sdk/platform-tools:${HOME}/.gem/ruby/2.3.0/bin:/usr/lib/surfraw:/store/local/Wolfram/CDFPlayer/10.3/Executables:/store/local/bin:${HOME}/.linuxbrew/bin:${HOME}/GNUstep/Tools:/bin:/sbin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/usr/lib/jvm/default/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:${HOME}/code/go/bin:/opt/TIS-100:/opt/cuda/bin"
# default PATH
