      ...
      for (j = 0, len = stack.length; j < len; j++) {
        ...
        switch (entry.type) {
          case 'checkpoint':
            ...
            break;
          case 'transaction':
            results.push(new Transaction(MarkerLayer.deserializeSnapshot(entry.markerSnapshotBefore), Patch.deserialize(entry.patch), MarkerLayer.deserializeSnapshot(entry.markerSnapshotAfter)));
            break;
          case 'patch':
