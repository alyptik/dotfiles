...
class StatusIcon extends HTMLElement
  ...
  initialize: (@terminalView) ->
    @classList.add 'fusion-terminal-status-icon'
  ...
  updateTooltip: ->
    ...
    @dispatchEvent(new CustomEvent('mouseenter', bubbles: true, detail: 'terminal-fusion'))
...
module.exports = document.registerElement('fusion-terminal-status-icon', prototype: StatusIcon.prototype, extends: 'li')
