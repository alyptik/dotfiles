...
() {
	...
	gnu_generic_cmds+=(keyring kid3-cli kid3-qt ld lighttpd2 ln lrz lua lz4 maim mkchromecast)
	gnu_generic_cmds+=(more mountpoint mpd muttprint mv named ncat ncdu neomutt netstat)
...
hash -d code="/store/projects/school"
