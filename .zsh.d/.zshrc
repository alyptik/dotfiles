...
() {
	...
	gnu_generic_cmds+=(mkchromecast more mountpoint mpd muttprint mv named ncat ncdu ncdu-bin)
...
hash -d git="$HOME/git"
hash -d guru="/store/projects/guru"
...
hash -d patch="/store/patches"
hash -d pbot="/store/projects/pbot"
hash -d portage="/store/projects/portage"
