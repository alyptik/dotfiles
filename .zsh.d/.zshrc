...
hash -d audio="/media/sdxc/audio"
hash -d b="$HOME/bin/"
hash -d c="$CONFIG"
hash -d calibre="/media/sdxc/calibre"
...
hash -d djzomg="/media/sdxc/Music/djzomg"
hash -d efi="/boot/EFI"
hash -d euler="$HOME/code/euler"
hash -d f="$PROJECTS/fastly"
hash -d fsm="$PROJECTS/fastly/libfsm"
hash -d g="$HOME/lind_project/lind/lind_glibc"
hash -d git="$HOME/git"
hash -d hdd="/media/toshiba1TB"
...
hash -d pics="/media/sdxc/work/pictures"
...
hash -d vim="$HOME/.vim"
hash -d vm="/store/vm"
hash -d w="/media/sdxc/work"
hash -d wanderlust="/media/toshiba1TB/wanderlust"
