...
() {
	...
	gnu_generic_cmds+=(neomutt netstat newsbeuter newsboat node nohup objconv objdum)
	gnu_generic_cmds+=(poomox-cli openvpn optipng pacconf pactree pandoc paste pisg pstree)
