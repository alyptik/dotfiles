...
let g:clang_cpp_options=''
	...
	\ . '-I./ -I../ -I../../ -I../../../ -I./src/ -I./t/ -I./contrib/libtap/ '
	...
	\ . '-Wall -Wextra -pedantic -Wno-format-truncation '
	\ . '-Wno-gnu-statement-expression -Wno-gnu-zero-variadic-macro-arguments '
	\ . '-Wno-keyword-macro -Wno-unused-function -Wno-missing-braces '
...
" cLIpboard mappings
vmap <F6> "+y<Esc>:call system("wl-copy", getreg("\""))<CR>
vmap <C-F6> <F6>v`>"+x
vmap <Esc><F6> <F6>v`>
nmap <F7> :call setreg("\"",system("wl-paste 2>/dev/null"))<CR>"+p
nmap <C-F7> :set paste<CR>i<CR><CR><Esc>k:.!wl-paste<CR>JxkJx:set nopaste<CR>
"nmap <C-F7> mz:call setreg("\"",system("xsel -op 2>/dev/null"))<CR>"+gP
nmap <Esc><F7> mz:-1r !wl-paste 2>/dev/null<CR>`z
